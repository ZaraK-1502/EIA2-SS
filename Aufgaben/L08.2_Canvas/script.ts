...
namespace AufgabeCanvas {
    
    let canvas: HTMLCanvasElement = document.body.querySelector ("canvas");
    ...
    function drawBackground(): void {
        ...
        function drawSun(): void {
            let gradient2: CanvasGradient= crc2.createRadialGradient(500,300,5,500,400,200);
