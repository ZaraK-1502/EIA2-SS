...
(function (Aufgabe9_2) {
    ...
    let cloud1 = new clouds(500, 530, 560, 593, 95, 75, 75.5, 30, 25, 30.2, 100, 50);
    let cloud2 = new clouds(800, 830, 870, 900, 115, 95, 95.5, 30, 20, 30, 100, 50);
    let boat1 = new boat(75, 105, 155, 185, 120, 125, 150, 100, 269.5, 300, 270, 220, 250, 230, 50, 5, 31, -55);
    function hndLoad() {
        drawBackground();
        drawPalm();
        sunOne.drawSun();
...
//# sourceMappingURL=script%20Kopie.js.map